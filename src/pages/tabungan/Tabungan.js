                            ...
                            <form>
                                ...
                                <div>
                                    ...
                                    <div style={{marginTop: 20}}>
                                        ...
                                        <div style={{marginTop: 10, display: 'flex', justifyContent: 'space-between'}}>
                                            <label>Nama :</label>
                                            <input type='text' style={{width: '60%'}} value='Nama Nasabah' disabled />
                                        </div>
                                        <div style={{marginTop: 10, display: 'flex', justifyContent: 'space-between'}}>
                                            <label>Alamat :</label>
                                            <input type='text' style={{width: '60%'}} value='Alamat Nasabah' disabled />
                                        </div>
                                        <div style={{marginTop: 10, display: 'flex', justifyContent: 'space-between'}}>
                                            <label>Saldo Akhir :</label>
                                            <input type='text' style={{width: '60%'}} value='Saldo Akhir Nasabah' disabled />
                                        </div>
                                    </div>
                                </div>
                            </form>
