...
class Paket extends Component {
    ...
    pilihan = () => {
        for (var i = 0; i < this.state.pakets.length; i++) {
            var plhn = new Option(this.state.pakets[i].provider + " - Rp. " + this.state.pakets[i].harga, this.state.pakets[i].harga);
                ...
                <div style={{display: 'flex', justifyContent: 'flex-start'}}>
                    ...
                    <div style={{width: '80%', paddingLeft: '3%', paddingRight: '3%', paddingBottom: 20}}>
                        <div style={{marginBottom: 30}}>
                            <p style={{fontSize: 25, fontWeight: 'bold', marginTop: 30}}>Pembelian : Paket Data</p>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div style={{marginTop: 20}}>
                                        ...
                                        <div style={{marginTop: 10, display: 'flex', justifyContent: 'space-between'}}>
                                            ...
                                            <input type='text' style={{width: '60%'}} value='Paket Data' disabled />
                                        </div>
                                        <div style={{marginTop: 10, display: 'flex', justifyContent: 'space-between'}}>
                                    ...
                                    <div style={{marginTop: 20, display: 'flex', justifyContent: 'flex-end'}}>
                                        <input type='submit' onClick={this.bayarPaket} value='B A Y A R' style={{cursor: 'pointer'}} />
                                    </div>
                                </div>
                            </form>
                        </div>
