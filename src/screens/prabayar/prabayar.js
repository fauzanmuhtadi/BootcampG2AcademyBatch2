            ...
            <View style={{flex: 1, margin: 20}}>
                ...
                <View style={{marginTop: 35}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 15}}>
                        ...
                        <TextInput value='Voucher HP' style={{height: 25, width: '60%', borderWidth: 1, paddingVertical: 0, paddingHorizontal: 10}} editable={false} />
                    </View>
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 15}}>
                        ...
                        <View style={{height: 25, width: '60%', borderWidth: 1, paddingVertical: 0}}>
                            <Picker
                                ...
                                <Picker.Item label="-- select voucher --" value="0" />
                                {this.state.vouchers.map((myValue, myIndex) => {
                                        return (
                    ...
                    <View style={{marginVertical: 15}}>
                        <TouchableOpacity onPress={this.bayarVoucher} style={{backgroundColor: '#ffc271', height: 50, borderRadius: 50, marginTop: 10, alignItems: 'center', justifyContent: 'center'}}>
