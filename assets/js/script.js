...
if (document.getElementById("datalogin") != null) {
    ...
    document.getElementById("datalogin").innerHTML = "Hi" + " " + a + "!"
}
...
// function tampilkanAssignment() {
    ...
    for (let i = 0; i < dataAssignment.length; i++) {
        ...
        row.insertCell(3).innerHTML = `
            <div class="dropdown">
                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Pilih Departemen
                <span class="caret"></span></button>
                <ul class="dropdown-menu">
                    <li class="nav-item dropdown"><a class="dropdown-item" href="#">Dep1</a></li>
                    <li class="nav-item dropdown"><a class="dropdown-item" href="#">Dep2</a></li>
                    <li class="nav-item dropdown"><a class="dropdown-item" href="#">Dep3</a></li>
                </ul>
            </div>`
